...
import img from '@/public/cancelTask.svg';

const Cancel: NextPageWithLayout = () => {
	return (
		<Layout>
			<div className={styles.signupContainer}>
				...
				<div className={styles.personalContainer}>
					<div className={styles.txtContainer}>
						<h2>Oops ‼️</h2>
						<h3>You have Cancelled an Assignment</h3>
						<h3 className={styles.alttxt}>
							Let&apos;s see some pending tasks.
						</h3>
						<Link href='/dashboard'>
...
Cancel.getLayout = function getLayout(page: ReactElement) {
	return (
		<>
			<Header title='Cancel' back='/dashboard' action='search' />
			{page}
		</>
	);
};
